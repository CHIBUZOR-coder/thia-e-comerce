...
const Allslides = () => {
  ...
  const slides = useMemo(
    () => [<First key={First} />, <Second key={Second} />, <Third key={Third} />, <Fourth key={Fourth}/>, <Fifth key={Fifth}/> ],
    []
  )
  ...
  return (
    <div className="w-full md:w-1/2 px-1 md:px-2 overflow-hidden md:-mt-10 mt-3 md:py-16">
