...
const Home = () => {
  return (
    <div>
      ...
      <div className="  pt-5 footer w-full h-product2 bg-primary">
        ...
        <div className="w-full px-5 flex justify-center">
          <div className="w-full gap-y-10 flex-col flex md:flex-row justify-center md:gap-x-80 items-center">
            ...
            <div className=" mt-10 footerLogo h-40  flex flex-col items-center w-40"></div>
            <div className="my-5 md:my-auto">
              <div
