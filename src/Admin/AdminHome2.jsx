...
const AdminHome2 = () => {
  ...
  const selected = Allproducts.filter(
    (prod) => prod.id >= 24 && prod.id <= 42
  );

  const links = [
    { id: 1, path: "/thia-e-comerce/Admin" },
    { id: 2, path: "/thia-e-comerce/Admin2" },
    { id: 3, path: "/thia-e-comerce/Admin3" },
    { id: 4, path: "/thia-e-comerce/Admin4" },
  ];
  return (
    <div
      className={`${
      ...
      } w-full flex justify-center min-h-[100vh] items-start p-3 bg-center bg-cover`}
    >
